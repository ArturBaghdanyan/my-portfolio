  ...
  return (
    <div>
      ...
      <Card>
        <div
          ref={containerRef}
          className={`w-full sm:w-4/5 h-auto mx-auto flex flex-wrap gap-x-4 gap-y-6 mt-8 justify-center rounded-xl bg-gradient-to-br from-blue-200 via-blue-200 to-indigo-200 shadow-lg p-3 transition-all duration-700 ease-out lg:w-full ${
